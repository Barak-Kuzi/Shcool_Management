...
const StudentForm: React.FC<StudentFormProps> = ({setShowModal, type, data, relatedData}) => {
    const {
        register,
        formState: {errors},
    ...
    const action = type === 'create' ? createStudent.bind(null, img) : updateStudent.bind(null, img);
