...
const TeacherForm: React.FC<TeacherFormProps> = ({type, data, setShowModal, relatedData}) => {
    const {
        register,
        formState: {errors},
    ...
    const action = type === 'create' ? createTeacher.bind(null, img) : updateTeacher.bind(null, img);
